...
define([
	...
	function (
		...
		ParticlesAPI.prototype.createParticleSystem = function(systemConfig, rendererConfigs, atlasConfigs) {
			this.particleSystem.add(systemConfig, rendererConfigs,atlasConfigs)
		};
