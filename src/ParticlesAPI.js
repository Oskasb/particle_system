...
define([
	...
	function (
		...
		ParticlesAPI.prototype.createParticleSystem = function(systemConfigs, rendererConfigs, atlasConfigs) {
			this.particleSystem.add(systemConfigs, rendererConfigs,atlasConfigs)
		};
